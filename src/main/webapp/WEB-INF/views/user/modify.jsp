	...
	<div class="col-lg-6" align="center">
		<form id="memberform" method="post" action="">
			...
			<div class="form-group" align="left">
				...
				<input type="text" class="form-control" id="userEmail" name="userEmail" placeholder="${user.userEmail }" size="25">
			...
			<div class="form-group" align="left">
				...
				<input type="text" class="form-control" id="address" name="userAddress" placeholder="${user.userAddress }">
